...
import {DeployMyToken} from "../../../script/my-token/DeployMyToken.s.sol";
import {MyToken} from "../../../src/my-token/MyToken.sol";
...
contract MyTokenTest is Test, ZkSyncChainChecker {
